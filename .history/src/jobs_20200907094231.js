  ...
  return (
    ...
    <div className=" flex flex-row flex-wrap  my-auto px-4" >
      {jobState.map((item, index) => {
        return (
           <div
            className="rounded overflow-hidden bg-white shadow-lg  mx-auto mt-20 w-1/4 flex-wrap"
            key={index}
            >
              {/* <idv > */}
...
<div className="py-10 px-4 ">
            <h3 className="text-left text-2xl mx-2 font-sans font-medium"> {item.job_name} </h3>
            <p className="text-base text-left mx-2 font-sans  mb-8"> {item.description}</p>
