...
export default function Jobs(vacancy) {
  ...
  return (
    (vacancy = "anything"),
    (
      <div className="max-w-full flex flex-row flex-wrap  justify-center sm:flex-col">
        {jobState.map((item, index) => {
          return (
            <div
              className="rounded overflow-hidden bg-black shadow-lg  mx-auto mt-20 w-1/4 md:w-1/4 "
              key={index}
            >
