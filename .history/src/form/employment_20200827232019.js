    ...
    <div className="form">
      <div className=" max-w-xl rounded overflow-hidden bg-white shadow-lg mx-auto mt-10 p-8">
        ...
        <div className="flex flex-col my-4">
          ...
          <FormInput placeholder="If you have any additional more skills please describe" className="mt-8"/>
    ...
    <div className=" max-w-xl rounded overflow-hidden bg-white shadow-lg mx-auto mt-10 p-8">
      <div className="flex flex-col my-4">
        <div className="flex flex-row my-4">
          <h3 className="my-8 text-2xl"> Refrence </h3>
          ...
          <div className="mt-10">
            ...
            <FormInput placeholder="ref_relation" name="relation" />
            <FormInput placeholder="ref_phone" name="phone" />
          </div>
          <div className="flex  justify-around flex-row mt-4 ">
        <Operations
          onClick={() => {
