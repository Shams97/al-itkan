    ...
    <div className="mx-auto mt-10 p-8">
      ...
      <div className="flex flex-col my-4">
        ...
        <div className="flex flex-row justify-between flex-wrap ">
          ...
          <div className="flex flex-row">
            <span className="mx-4 mt-5">When can ou begin to work?</span>
        ...
        {/* Additional skills  */}
        <div className="mt-10">
          <p className="text-center text-xl my-4 ">Add more additional skills</p>
          <div className="flex felx-row flex-wrap px-14  mx-8">
            <div className="flex flex-row my-2">
              <span className="mx-4 mt-5">Team Work Skills</span>
              <Selector
                name="team_work"
                ops={[
                  "Excellent",
    ...
    <div className=" mx-auto mt-10 p-8">
      <div className="flex flex-col my-10">
        ...
        <div className="flex flex-row my-2 mx-2">
          ...
          <span className="text-sm mx-4 mt-5">signature date</span>
