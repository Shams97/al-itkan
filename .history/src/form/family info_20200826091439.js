...
{show.map((item)=>console.log("item==", item))}
       {/* {show.split('').map((input,index)=>{
            return <div className="flex  flex-col mx-4 mb-4" key={index}>
            <FormInput
              placeholder="Brother/sister first name "
              name="first_name"
              value={input}
...
{/* 
          ...
          <div className="flex  justify-around flex-row">
            <button onClick={() =>  {setShow({show:[...show]}); console.log("show =", show)} }>+</button>
