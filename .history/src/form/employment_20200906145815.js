...
export default function Employment() {
  ...
  return (
    <div className=" w-5/6 rounded overflow-hidden bg-white shadow-lg mx-auto mt-10 p-8">
      ...
      <p className="mt-8 font-serif text-red-400 ">Want to provide more than one employer ? </p>
...
<div className="flex flex-row justif-around ">
          ...
          <div className="flex flex-row ">
            ...
            <FormInput name="driver_license_date" type="date" className=""/>
          </div>
         </div>
