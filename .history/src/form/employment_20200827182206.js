  ...
  return (
    <div className=" max-w-xl rounded overflow-hidden bg-white shadow-lg mx-auto mt-10 p-8">
      ...
      <div className="flex flex-col m-2">
        ...
        <input placeholder="employer province" name="employer_province" />
        <input placeholder="from" name="from" type="date" className="w-25"/>
        <input placeholder="to" name="to" type="date"/>
       </div>
