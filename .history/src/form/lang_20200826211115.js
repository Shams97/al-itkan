           ...
           {show.map((input, index) => {
            ...
            return (
              ...
              <FormInput placeholder="add the name of language you know" className="mb-2 mt-4" name="other"/>
               ...
               <label className="mb-4" htmlFor="arabic"> Read</label>
               ...
               <label className="mb-4" htmlFor="arabic"> Write</label>
               <select className="border-b-2 border-black-400 focus:border-blue-500  outline-none  text-sm text-gray-600 px-8">
                 <option value="excellent">excellent</option>
                 <option value="very good">very good </option>
                 <option value="good">good </option>
               ...
               <label className="mb-4" htmlFor="arabic"> Speak</label>
               <select className="border-b-2 border-black-400 focus:border-blue-500  outline-none text-sm text-gray-600 px-8">
                 <option value="excellent">excellent</option>
                 <option value="very good">very good </option>
                 <option value="good">good </option>
               ...
               <label className="mb-4" htmlFor="arabic"> Understand</label>
               <select className="border-b-2 border-black-400 focus:border-blue-500  outline-none text-sm text-gray-600 px-8">
                 <option value="excellent">excellent</option>
                 <option value="very good">very good </option>
                 <option value="good">good </option>
               ...
               <label className="mb-4" htmlFor="arabic"> Overall</label>
               <select className="border-b-2 border-black-400 focus:border-blue-500  outline-none  text-sm text-gray-600 px-8">
                 <option value="excellent">excellent</option>
                 <option value="very good">very good </option>
                 <option value="good">good </option>
