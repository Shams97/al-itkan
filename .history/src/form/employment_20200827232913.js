    ...
    <div className=" max-w-xl rounded overflow-hidden bg-white shadow-lg mx-auto mt-10 p-8">
      <div className="flex flex-col my-10">
          ...
          <p className="text-center ">
            ...
            <FormInput placeholder="ref_relation" name="ref_relation" />
            <FormInput placeholder="ref_phone" name="ref_phone" />
          </div>

        { hide?  <div className="mt-10 flex flex-col">
            <FormInput placeholder="name" name="ref_name_1" />
            <FormInput placeholder="ref_relation" name="ref_relation_1" />
            <FormInput placeholder="ref_phone" name="ref_phone_1" />
          </div>:null}
