...
<p className="mt-10"> sign here to ensure that every information you provide is correct </p>
         ...
         <div className="flex flex-row my-2 mx-2">
           ...
           <div className="flex flex-col my-10">
             ...
             <div className="flex flex-row">
               <label className="mx-2 mt-2"> photo</label>
               <FormInput name="photo" type="file" />
             </div>

             <div className="flex flex-row ">
               <label className="mx-2 mt-2 px-4"> national ID </label>
               <FormInput name="national_id" type="file" />
             </div>
             <div className="flex flex-row">
               <label className="mx-6 mt-2 px-8"> citizenship certificate</label>
               <FormInput name="citizenship_cert" type="file" />
             </div>
             <div className="flex flex-row">
               <label className="mx-2 mt-2"> university degree</label>
               <FormInput name="uni_degree" type="file" />
             </div>
             <div className="flex flex-row">
               <label className="mx-2 mt-2"> medical test </label>
               <FormInput name="medical" type="file" />
             </div>
             <div className="flex flex-row">
               <label className="mx-2 mt-2"> no criminal record </label>
               <FormInput name="no_crim_req" type="file" />
             </div>
             <div className="flex flex-row">
               <label className="mx-2 mt-2"> letter of recommendation 1</label>
               <FormInput name="letter_rec_1" type="file" />
             </div>
             <div className="flex flex-row">
               <label className="mx-2 mt-2"> letter of recommendation 2</label>
