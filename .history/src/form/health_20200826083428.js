  ...
  return (
    <div className="form">
      ...
      <h3> Health and limitation </h3>
        ...
        <div className="bg-gray-300 mt-2">
          <label className="p-4">Are there any limitations on your ability to perform in your prospective field of work? </label>
          <div className="flex flex-row  justify-center my-4" >
            <label className="text-gray-600"> yes </label>{" "}
            <input
              type="radio"
        ...
        <div className="bg-gray-300 mt-2">
          <label className="p-4"> Are there any limitations on your ability to engage in all types of travel? Inside or outside Iraq </label>
          <div className="flex flex-row  justify-center my-4">
            <label className="text-gray-600"> yes </label>{" "}
            <input
              type="radio"
