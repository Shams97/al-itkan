...
const onSubmit  =data =>{
  ...
  return (
    <div>
      ...
      <input  onChange={()=>setState([...input_value, {}]) } type="text" placeholder="trying " ref={register} />
      <input  onChange={()=> setState([...input_value, {}])} type="file" ref={register} />
      <input  onChange={()=> setState([...input_value, {}])} type="date" ref={register} />
