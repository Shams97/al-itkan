...
export default function Language() {
 ...
 const [hide, setHide] = useState(false);
  ...
  return (
    <div>
      <div className=" max-w-3/4	rounded overflow-hidden bg-white shadow-lg mx-auto mt-10 p-8 ">
          <h2 className="my-8 text-xlg"> Language an level of proficiency </h2>
          ...
          <select className="border-b-2 border-black-400 focus:border-blue-500  outline-none px-4 py-2">
           ...
           {show.map((input, index) => {
            let n = index;
            return (
              <div className="flex flex-col mx-4 mt-8 justify-center"> 
