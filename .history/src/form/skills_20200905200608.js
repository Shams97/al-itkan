  ...
  return (
    <div className="w-5/6 rounded overflow-hidden bg-white shadow-lg mx-auto mt-10 p-8">
      ...
      <div className="flex  flex-col">
        ...
        <p className="text-red-400  my-4"> Add more technical skills </p>
...
const OptionField = ({name, logic_name}) => {
  ...
  return (
    <div className="flex flex-row flex-wrap justify-center">
      <p className="text-center mt-4 w-1/2">{name}</p>
      <div className="flex flex-row jusitfy-between mx-auto my-4 w-1/2">
