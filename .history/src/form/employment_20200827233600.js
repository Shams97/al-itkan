...
<p> sign here to ensure that every information you provide is correct </p>

         <div className="flex flex-row my-4 mx-2">

           <FormInput placeholder="your signature" name="signature" />
           <span>signature date</span><FormInput name="sig_date" type="date" />
           </div> 
          
          
          <h3 className="my-12 text-2xl "> </h3>
        </div>
