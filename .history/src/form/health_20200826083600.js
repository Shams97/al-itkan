  ...
  return (
    <div className="form">
      ...
      <h3> Health and limitation </h3>
        ...
        <div className="mt-2">
          <label className="p-4" for="disease">Have you suffered or are you suffering from any terminal illness or chronic disease? </label>
        ...
        <div className="mt-2">
          <label className="p-4" for="limitation">Are there any limitations on your ability to perform in your prospective field of work? </label>
          <div className="flex flex-row  justify-center my-4" >
            <label className="text-gray-600"> yes </label>{" "}
            <input
              type="radio"
        ...
        <div className="mt-2">
          <label className="p-4" for="travel_limitation"> Are there any limitations on your ability to engage in all types of travel? Inside or outside Iraq </label>
          <div className="flex flex-row  justify-center my-4">
            <label className="text-gray-600"> yes </label>{" "}
            <input
              type="radio"
