    ...
    <div className=" max-w-xl rounded overflow-hidden bg-white shadow-lg mx-auto mt-10 p-8">
      ...
      <div className="flex flex-col m-2">
        ...
        <div className="flex flex-row  my-2">
          ...
          <FormInput placeholder="to" name="to_date" type="date" className="placeholder:none"/>
        </div>
...
{show.map((input, index , m) => {
        ...
        <FormInput placeholder={"employer name"+n} name={"employer_name_"+n} />
        ...
        <div className="flex flex-row  my-2">
          <span className="text-sm mx-4 mt-5">from</span>
          <FormInput placeholder="from" name={"from_date_"+n} type="date" />
          <span className="text-sm mx-4 mt-5">to</span>
          <FormInput placeholder="to" name={"to_date_"+n} type="date" className="placeholder:none"/>
        </div>
        ...
        <FormInput placeholder="supervisor" name="supervisor" />
        <FormInput placeholder="supervisor phone No." name={"super_phone_"+n} />
  ...
  return (
    <div className="form">
      ...
      <h3 className="my-8 text-2xl"> Additional information   </h3>
        ...
        <div className="">
          <Option htmlFor="union_member" label_value="Are you a member of the Iraqi engineers union?"/> 
          <FormInput placeholder="from" name="from_date" type="date" />
          <Option htmlFor="driver_license" label_value="Do you have a valid drivers license?"/> 
          <span className="text-sm mx-4 mt-5">if yes since when ?</span>
          <FormInput name="driver_license_date" type="date" />
          <FormInput placeholder="What is your means of transport?(Personal Car, Public, etc." name="means_of_transport" />
     
     <Option label_value="Are you good in keeping appointments?" htmlFor="good_appoint"/>
     <Option label_value="Do you smoke ?" htmlFor="smoking"/>
     <Option label_value="" htmlFor="long_hours"/>
...
const Options = ({htmlFor, label_value})=>{
 ...
 <label className="p-4" htmlFor={htmlFor}>{label_value}</label>
