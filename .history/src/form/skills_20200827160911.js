    ...
    return     <div className=" max-w-xl rounded overflow-hidden bg-white shadow-lg mx-auto mt-10 p-8">
     ...
     <div className="flex  flex-col my-4">
       <p> write down what you good at and how much </p>
        <FormInput placeholder="your technical skills " name="technical_skills_1" />
        <Option_field/>
...
const Option_field = () =>{
  return  <div className="flex flex-row jusitfy-between mx-auto my-4">
    <input
      type="radio"
      className="checked:bg-gray-900 checked:border-transparent mx-4 bg-gray mt-2 text-gray-300"
      value="not familiar"
      name="not familiar"
    />
