...
const onSubmit  =data =>{
  ...
  return (
    <div>
      ...
      <FormInput  onChange={()=>setState([...input_value, {}]) } type="text" placeholder="trying " ref={register} value={register}/>
      <FormInput  onChange={()=> setState([...input_value, {}])} type="file" ref={register} value={register}/>
      <FormInput  onChange={()=> setState([...input_value, {}])} type="date" ref={register} value={register}/>
