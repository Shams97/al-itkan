...
const SelectField = ({language,forValue})=>{
  ...
  <label htmlFor="arabic" className="mb-8">Read</label>
  <select className="border-b-2 border-black-400 focus:border-blue-500  outline-none text-xs text-gray-300">
    <option value="excellent" className="text-xs text-gray-300">excellent</option>
    <option value="very good" className="text-xs">very good </option>
    <option value="good" className="text-xs">good </option>
    <option value="average" className="text-xs">average</option>
    <option value="below average">below average</option>
  </select>

  <label htmlFor="arabic"> Write</label>
  <select className="border-b-2 border-black-400 focus:border-blue-500  outline-none  p-2">
    <option value="excellent">excellent</option>
    <option value="very good">very good </option>
    <option value="good">good </option>
